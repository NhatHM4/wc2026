...
public class MatchSyncServiceImpl implements MatchSyncService {
    ...
    private List<Match> generateMockWorldCupMatches() {
        ...
        Match m1 = Match.builder()
                ...
                .homeTeam("Hoa Kỳ (USA)")
                .awayTeam("Mexico")
                .matchTime(LocalDateTime.now(java.time.ZoneId.of("UTC")).plusDays(2))
                .status("SCHEDULED")
        ...
        Match m2 = Match.builder()
                ...
                .matchTime(LocalDateTime.now(java.time.ZoneId.of("UTC")).plusDays(5))
                .status("SCHEDULED")
                .poolAmount(BigDecimal.ZERO)
                .settled(false)
                .build();
        ...
        Match m3 = Match.builder()
                ...
                .matchTime(LocalDateTime.now(java.time.ZoneId.of("UTC")).minusMinutes(45))
                .status("IN_PLAY")
                .homeScore(1)
                .awayScore(0)
        ...
        Match m4 = Match.builder()
                ...
                .matchTime(LocalDateTime.now(java.time.ZoneId.of("UTC")).minusHours(3))
                .status("FINISHED")
                .homeScore(3)
                .awayScore(2)
